Scheme
{
	BaseSettings
	{
		...
		// Loadout buttons [ty hypnotize for the help]
		Econ.Dialog.BgColor									"Blank"
		Econ.Button.BgColor									"black"
		Econ.Button.FgColor									"white"
		Econ.Button.ArmedBgColor							"zephyr"
		Econ.Button.ArmedFgColor							"white"
		Econ.Button.DepressedBgColor						"zephyr"
		Econ.Button.DepressedFgColor						"75 75 75 255"
		
		Econ.Button.PresetDefaultColorFg					"nüWhite"
		Econ.Button.PresetArmedColorFg						"nüWhite"
		Econ.Button.PresetDepressedColorFg					"nüWhite"
		
		Econ.Button.PresetDefaultColorBg					"zephyr" 
		Econ.Button.PresetArmedColorBg						"zephyr"
		Econ.Button.PresetDepressedColorBg					"zephyr" 
		...
		Button.BgColor					"15 15 15 255"
		Button.ArmedTextColor			"nüWhite"
		Button.ArmedBgColor				"zephyr"
		...
		HudObjectives.BorderColor	"noborder"
